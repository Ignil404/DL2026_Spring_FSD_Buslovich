...
class Answer(Base):
    ...
    round_id = Column(String(36), ForeignKey("rounds.id"), nullable=False, index=True)  # Index for round lookups
    ...
    __table_args__ = (
        ...
        # Validate scores
        CheckConstraint('base_points >= 0', name='check_base_points'),
        CheckConstraint('speed_multiplier >= 0 AND speed_multiplier <= 1', name='check_speed_multiplier'),
