...
class LeaderboardEntry(Base):
    ...
    total_score = Column(Integer, nullable=False, index=True)  # Index for leaderboard queries
    submitted_at = Column(DateTime, default=datetime.utcnow, index=True)  # Index for time-based queries
    ...
    __table_args__ = (
        ...
        Index('idx_leaderboard_score', 'total_score', mysql_length=10),  # Index for ORDER BY score DESC
    )
